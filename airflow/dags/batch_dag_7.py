...
with DAG(
    ...
    description='Query 7 processing',
    ...
    for script in scripts:
        ...
        tasks[task_id] = BashOperator(
            task_id=task_id,
            bash_command=f"spark-submit --master spark://spark-master:7077 --jars $(echo /opt/spark/jars/*.jar | tr ' ' ',') --executor-memory 8G --driver-memory 4G  {pyspark_app_home}/{script}",
            env={
